...
@mcp.tool
async def get_kubernetes_metrics(run_id: str, start_time: str, end_time: str, ctx: Context) -> str:
    """
    Retrieves Kubernetes CPU metrics for all services in the current environment context.
    Outputs a CSV artifact in the artifacts directory for the given run_id.
